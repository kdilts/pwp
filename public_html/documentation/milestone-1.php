...
<html lang="en">
	...
	<body>
		<header>
			<h1 id="titleheader">kdilts PWP Milestone 1</h1>
		</header>
		<main>
			<section>
				<h2 class="subheading">Purpose</h2>
				<p>The purpose of this website is to serve as a portfolio and showcase some of my prior work.</p>
			</section>

			<section>
				<h3 class="subheading">Audience</h3>
				<p>My intended audience is primarily employers and / or prospective clients. Other audience members could be peers, or family and friends that I would like to show my work to.</p>
			</section>
