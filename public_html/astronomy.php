					...
					<div class="col-xs-12">
						<div class="carousel" id="flick" data-flickity='{ "wrapAround": true }'>
							...
							<div class="carousel-cell cell-text">
								<a href="apps/milkyway/milkyway.php">
							...
							<div class="carousel-cell cell-text">
								<a href="apps/solarsystem/solarsystem.php">
							...
							<div class="carousel-cell cell-text">
								<a href="apps/retrograde/retrograde.php">
							...
							<div class="carousel-cell cell-text">
								<a href="apps/spectroscopic/spectroscopic.php">
							...
							<div class="carousel-cell cell-text">
								<a href="apps/eclipsing/eclipsing.php">
